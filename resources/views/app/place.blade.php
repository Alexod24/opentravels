        ...
        <div class="lg:col-span-5 lg:col-start-8">
          ...
          <div class="mt-4">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4 flex">
                <a href="#" class="text-sm font-medium text-emerald-600 hover:text-emerald-500">See all 512 reviews</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <form>
            ...
            <div class="mt-8">
              <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-sm font-medium text-emerald-600 hover:text-emerald-500">See sizing chart</a>
              </div>
              ...
              <fieldset class="mt-2">
                ...
                <div class="grid grid-cols-3 gap-3 sm:grid-cols-6">
                  <!--
                    ...
                    Checked: "border-transparent bg-emerald-600 text-white hover:bg-emerald-700", Not Checked: "border-gray-200 bg-white text-gray-900 hover:bg-gray-50"
                  -->
